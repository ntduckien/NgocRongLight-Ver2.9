            ...
            <main>
                <div class="row">
                    <div class="col-md-9 pb-3 pt-2">
                        <h3>Cộng Tiền - Máy Chủ 1</h3>
                        <p class="text-muted">Cộng Tiền tài khoản cho thành viên trong Máy Chủ 1 (Không tính vào tổng
                            nạp)</p>
                        <hr>
                        <table class="table">
                    </div>
                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                            ...
                            <form method="POST">
                                ...
                                <button class="btn btn-outline-primary" type="submit">Cộng</button>
                            </form>
                        </div>
