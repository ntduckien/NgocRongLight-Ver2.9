            ...
            <main>
                <div class="row">
                    <div class="col-md-9 pb-3 pt-2">
                        <h3>Mở Khoá Tài Khoản - Máy Chủ 1</h3>
                        <p class="text-muted">Mở khoá những tài khoản vi phạm, không vi phạm ở bảng phong thần </p>
                        <hr>
                        <table class="table">
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if ($result->num_rows == 0) {
                                    ...
                                    if ($is_banned === '0') {
                                        ...
                                        $_alert = '<div class="alert alert-warning">Tài khoản này không bị khoá!</div>';
                                    } else {
                                        ...
                                        if ($conn->query($sql2) === TRUE) {
                                            ...
                                            $_alert = '<div class="alert alert-success">Mở Khoá tài khoản thành công!</div>';
                                        } else {
                            ...
                            <form method="POST">
                                ...
                                <button class="btn btn-outline-primary" type="submit">Mở Khoá</button>
                            </form>
                        </div>
