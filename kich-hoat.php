            ...
            <div class="col-10 pl-0">
               <div class="alert alert-success">
                  ...
                  <span style="color:#dc3545"><strong>
                        ...
                        số tính năng.<br>
                        Mở thành viên Light người chơi sẽ được rất nhiều quyền lợi :
                  </span>
                  <br>
                  <br>
                  <span style="color:#343a40;">
                  ...
                  <b>- Nạp Qua Ví Momo, Thẻ Cào hãy đọc kĩ hướng dẫn
                     <br>
                     - Sai nội dung, tên tài khoản không hỗ trợ
                     <br>
                     - Gặp lỗi ib page để được hỗ trợ
                     <br>
                     <br>
                     <span style="color:#212529"><strong>Bước 2 : Kiểm Tra Số Dư
                     </strong>
                  </span>
                  <br>
                  ...
                  <br>
                     ...
                     Sau khi nạp tiền vào tài khoản các bạn hãy nhấn vào: <a href="/mothanhvien">Mở Thành
                        Viên</a><br>
                     ...
                     <a href="login"><b class="text-primary"> Nạp Tại Đây </b></a><br>
                     <b class="text text-danger">Lưu ý :</b></br>
                     - Nạp Qua Ví Momo, Thẻ Ngân Hàng hãy đọc kĩ hướng dẫn <b>
                        ...
                        Sau khi nạp tiền các bạn có thể kiểm tra số dư
                        <a href="profile"><b class="text-primary"> Tại Đây </b></a></br>
