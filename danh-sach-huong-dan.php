            ...
            <div class="row g-4 py-4 row-cols-1 row-cols-md-4">
                <div class="col d-flex align-items-stretch">
                    <div class="feature-box">
                        ...
                        <br>
                        <div>
                            <a href="huong-dan" class="feature-title">Hướng Dẫn Nạp</a>
                            <p>Hướng dẫn nạp thẻ và quy đổi Thỏi Vàng</p>
                            <a href="huong-dan" class="btn btn-primary">
                                Xem ngay
                            </a>
                        </div>
                    </div>
                ...
                <div class="col d-flex align-items-stretch">
                    <div class="feature-box">
                        ...
                        <br>
                        <div>
                            <a href="kich-hoat" class="feature-title">Hướng Dẫn Kích Hoạt</a>
                            <p>Hướng dẫn kích hoạt thành viên trong máy chủ.</p>
                            <a href="kich-hoat" class="btn btn-primary">
                                Xem ngay
                            </a>
                        </div>
                    </div>
                ...
                <div class="col d-flex align-items-stretch">
                    <div class="feature-box">
                        ...
                        <br>
                        <div>
                            <a href="mothanhvien" class="feature-title">Mở Thành Viên</a>
                            <p>Kích hoạt thành viên trong máy chủ.</p>
                            <a href="mothanhvien" class="btn btn-primary">
                                Xem ngay
                            </a>
                        </div>
                    </div>
                ...
                <div class="col d-flex align-items-stretch">
                    <div class="feature-box">
                        ...
                        <br>
                        <div>
                            <a href="gt" class="feature-title">Giới Thiệu Người Mới</a>
                            <p>Giới thiệu người chơi mới tham gia.</p>
                            <a href="gt" class="btn btn-primary">
                                Xem ngay
                            </a>
                        </div>
                    </div>
