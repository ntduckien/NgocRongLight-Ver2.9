! function (e, t) {
    ...
    const S = () => f(".".concat(h.loader)),
        ...
        M = () => y(h.close),
        D = () => {
            const e = a(v().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort((e, t) => (e = parseInt(e.getAttribute("tabindex.php")), (t = parseInt(t.getAttribute("tabindex.php"))) < e ? 1 : e < t ? -1 : 0));
            var t = a(v().querySelectorAll('\n  a[href],\n  area[href],\n  input:not([disabled]),\n  select:not([disabled]),\n  textarea:not([disabled]),\n  button:not([disabled]),\n  iframe,\n  object,\n  embed,\n  [tabindex="0"],\n  [contenteditable],\n  audio[controls],\n  video[controls],\n  summary\n')).filter(e => "-1" !== e.getAttribute("tabindex.php"));
            return (t => {
                const n = [];
    ...
    }), rn.DismissReason = l, rn.version = "11.0.19";
    const cn = rn;
