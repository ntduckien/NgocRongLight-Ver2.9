...
class ExpressionParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('An argument must be a name. Unexpected token "string" of value "a" ("name" expected) in "index.php" at line 1.');
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('A default value for an argument must be a constant (a boolean, a string, a number, or an array) in "index.php" at line 1');
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('Unknown "cycl" function. Did you mean "cycle" in "index.php" at line 1?');
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('Unknown "foobar" function in "index.php" at line 1.');
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('Unknown "lowe" filter. Did you mean "lower" in "index.php" at line 1?');
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('Unknown "foobar" filter in "index.php" at line 1.');
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('Unknown "nul" test. Did you mean "null" in "index.php" at line 1');
    ...
    {
        $this->expectException('\Twig\Error\SyntaxError');
        $this->expectExceptionMessage('Unknown "foobar" test in "index.php" at line 1.');
