...
class __TwigTemplate_953d759ddc08b8ea703f4f5e1dd7c2b2d3ad45d552bc3e86ccb396721a4a6358 extends \Twig\Template
{
    ...
    <option value=\"-first\"";
        // line 6
        echo (((($context["current_index.php"] ?? null) == 0)) ? (" disabled=\"disabled\"") : (""));
        echo ">
        ";
        // line 7
        echo _gettext("first");
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["mi"]) {
            ...
            echo "\"";
            // line 11
            echo ((((($context["current_index.php"] ?? null) == $context["mi"]) || (($context["current_index.php"] ?? null) == ($context["mi"] + 1)))) ? (" disabled=\"disabled\"") : (""));
            echo ">
            ";
            // line 12
