...
($context["show_column_comments"] ?? null)]));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            // line 65
            echo "            ";
            if (twig_in_filter(($context["field_name"] ?? null), ($context["columns_with_index.php"] ?? null))) {
                // line 66
                echo "                ";
                $context["displayed_field_name"] = (($context["displayed_field_name"] ?? null) . PhpMyAdmin\Util::getImage("bd_primary", _gettext("index.php")));
                // line 69
                echo "            ";
            }
            // line 70
...
($context["titles"] ?? null), "columns_with_unique_index.php" =>                 // line 106
($context["columns_with_unique_index.php"] ?? null), "is_in_central_columns" => ((twig_in_filter($this->getAttribute(                // line 107
