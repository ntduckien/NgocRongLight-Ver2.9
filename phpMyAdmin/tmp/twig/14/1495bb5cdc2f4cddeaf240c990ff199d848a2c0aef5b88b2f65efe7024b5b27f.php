...
($context["field_name"] ?? null), ($context["columns_with_unique_index.php"] ?? null)), "has_link_class" => false, "url_query" =>         // line 32
...
($context["primary"] ?? null), "syntax" => "ADD index.php", "message" => _gettext("An index has been added on %s."), "action" => "index.php", "titles" =>         // line 55
